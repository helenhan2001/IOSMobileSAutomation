...
public class TimerPage extends BasePage {
	...
	@iOSFindBy(id = "com.spotlightsix.zentimerlite2:id/tab_timer")
	private MobileElement timerBtn;

	@iOSFindBy(id = "com.spotlightsix.zentimerlite2:id/timer_help")
	...
	@iOSFindBy(id = "com.spotlightsix.zentimerlite2:id/icon")
	private MobileElement timerIcon;

	@iOSFindBy(id = "com.spotlightsix.zentimerlite2:id/configuration_representation")
	private MobileElement timerConfig;

	@iOSFindBy(id = "com.spotlightsix.zentimerlite2:id/start_icon")
